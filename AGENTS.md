...
Guidance for AI coding agents working in **auto-sponsor-links**.

## Project overview

Monthly GitHub Actions workflow that detects repositories missing sponsor links and creates PRs to add them
